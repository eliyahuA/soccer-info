...
### Fixed
- Fixed validation error in MatchFull model when API returns empty list instead of None for odds field
...
[0.2.1]: https://github.com/eliyahuA/soccer-info/releases/tag/v0.2.1
