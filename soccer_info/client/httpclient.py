...
from .base_client import SyncClient, AsyncClient, T
from .championships import Championships, AsyncChampionships
...
class AsyncHTTPClient(AsyncClient):
    ...
    Provides high-level async access to all API endpoints through specialized
    domain clients (championships, teams, players, etc.). Handles async request 
    execution with httpx, response parsing, and error handling.
    ...
    def __init__(
        ...
        """Initialize the async Soccer API client.
    ...
    async def do_request(
        ...
        """Execute async HTTP request to Soccer Football Info API endpoint.
